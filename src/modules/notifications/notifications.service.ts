    ...
    try {
      ...
      if (serviceAccountRaw) {
        ...
        try {
          ...
          credentials = JSON.parse(serviceAccountRaw.replace(/\\n/g, '\n'));
        }
        ...
        this.logger.log('Firebase Admin initialized successfully from FIREBASE_SERVICE_ACCOUNT_BASE64.');
        ...
        this.logger.warn(
          'Firebase Admin credentials not found in FIREBASE_SERVICE_ACCOUNT or service-account.json. Push notifications are disabled.',
        );
      }
    } catch (e: any) {
